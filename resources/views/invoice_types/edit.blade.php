<x-layouts.app>
    ...
    <header class="main__header header">
        ...
        <a href="{{ route('invoice-types.index') }}" class="link btn">
            <i class="link__icon fa-solid fa-arrow-left"></i>
            <span class="link__text">Retour aux types de facture</span>
        </a>
    </header>
    ...
    <div class="main__content">
        <form class="form" method="POST" action="{{ route('invoice-types.update', ['invoiceType => $invoiceType']) }}" enctype="multipart/form-data">
            ...
            <div class="form__group">
                ...
                <input class="form__input" id="code" type="text" name="code" value="{{ old('code', $invoiceType->code) }}">
            ...
            <div class="form__group">
                ...
                <input class="form__input" id="label" type="text" name="label" value="{{ old('label', $invoiceType->label) }}">
